...
export class HelmetModelsService {
  ...
  async create(dto: CreateHelmetModelDto) {
    return this.db.helmet_model.create({
      data: {
        ...
        visor_pinlock: (dto.visorPinlock as any) ?? 'not_compatible',
  ...
  async update(id: string, dto: UpdateHelmetModelDto) {
    ...
    return this.db.helmet_model.update({
      ...
      data: {
        ...
        ...(dto.visorPinlock && { visor_pinlock: dto.visorPinlock as any }),
  ...
  private buildWhere(
    ...
    return {
      ...
      ...(filters.shellMaterial && { shell_material: filters.shellMaterial as any }),
      ...(filters.closureType && { closure_type: filters.closureType as any }),
      ...(filters.visorPinlock && { visor_pinlock: filters.visorPinlock as any }),
  ...
  private mapResponse(raw: any, adminView: boolean) {
    return {
      ...
      features: {
        ...
        visorPinlock: raw.visor_pinlock,
